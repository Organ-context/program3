		...
		<div class="row" id="form1">
			...
			<div class="col-md-5  col-lg-offset-1">
				<table id="dg" class="easyui-datagrid"
					style="width: 714px; height: 500px;" toolbar="#tb" title="操作日志"
					data-options="
						rownumbers:true,
						pageList:[10],
						singleSelect:true,
...
<script type="text/javascript">
	...
	function getData() {
		$('#dg').datagrid({
			url : '/billing/log/getOperationlogPager',
			queryParams : queryParams(),
			columns : [ [ {
				field : 'operateManagerName',
				title : '管理员名称',
				align : 'center',
				width : 110
			}, {
				field : 'operateManagerType',
				title : '管理员级别',
				align : 'center',
				width : 110
			}, {
