...
public class LoginlogMapperSqlProvider {
	...
	public String findAllByNum(Map<String, Object> map) {
		...
		if ((param1.get("LoginManagerName") != null
				&& StringUtils.hasLength(((String) param1.get("LoginManagerName")).trim()))) {
			sb.append("and login_manager_name like '" + param1.get("LoginManagerName") + "%'");
